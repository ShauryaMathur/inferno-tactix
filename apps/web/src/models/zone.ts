...
export const moistureLookupByLandCover: { [key in VegetationType]: number[] } = {
  ...
  [VegetationType.EvergreenBroadleaf]: [0.28, 0.3, 0.25, 0.29],
  [VegetationType.DeciduousNeedleleaf]: [0.2, 0.24, 0.18, 0.21],
  [VegetationType.DeciduousBroadleaf]: [0.22, 0.26, 0.2, 0.23],
  [VegetationType.MixedForest]: [0.19, 0.23, 0.17, 0.21],
  [VegetationType.ClosedShrublands]: [0.14, 0.18, 0.12, 0.15],
  [VegetationType.OpenShrublands]: [0.1, 0.14, 0.08, 0.11],
  [VegetationType.WoodySavannas]: [0.12, 0.16, 0.1, 0.13],
  [VegetationType.Savannas]: [0.09, 0.13, 0.08, 0.1],
  [VegetationType.Grasslands]: [0.08, 0.12, 0.07, 0.09],
  [VegetationType.PermanentWetlands]: [0.3, 0.33, 0.28, 0.31],
  [VegetationType.Croplands]: [0.13, 0.16, 0.12, 0.15],
  [VegetationType.UrbanBuilt]: [0.05, 0.08, 0.04, 0.06],
  [VegetationType.CroplandMosaic]: [0.12, 0.15, 0.1, 0.13],
  [VegetationType.SnowIce]: [0.0, 0.01, 0.0, 0.0],
  [VegetationType.Barren]: [0.01, 0.02, 0.01, 0.01],
  [VegetationType.Water]: [0.0, 0.0, 0.0, 0.0],
};
