...
describe('getFireSpreadRate', () => {
  ...
  it('calculates the fireSpreadRate correctly for grass fuel type', () => {
    ...
    expect(
      getFireSpreadRate(sourceCell, targetCell, { speed: 1, direction: 0 }, cellSize)
    ).toBeCloseTo(19.40563588);
    // cells F14:
    expect(
      getFireSpreadRate(sourceCell, targetCell, { speed: 2, direction: 0 }, cellSize)
    ).toBeCloseTo(33.46252017);
    // cells F32:
    expect(
      getFireSpreadRate(sourceCell, targetCell, { speed: 20, direction: 0 }, cellSize)
    ).toBeCloseTo(802.7428356);
  });
  ...
  it('calculates the fireSpreadRate correctly for shrub fuel type', () => {
    ...
    expect(
      getFireSpreadRate(sourceCell, targetCell, { speed: 1, direction: 0 }, cellSize)
    ).toBeCloseTo(14.143734476);
    // cells F14:
    expect(
      getFireSpreadRate(sourceCell, targetCell, { speed: 2, direction: 0 }, cellSize)
    ).toBeCloseTo(27.64726088);
    // cells F32:
    expect(
      getFireSpreadRate(sourceCell, targetCell, { speed: 20, direction: 0 }, cellSize)
    ).toBeCloseTo(541.68779579);
  });
  ...
  it('calculates the fireSpreadRate correctly for forest fuel type', () => {
    ...
    expect(
      getFireSpreadRate(sourceCell, targetCell, { speed: 1, direction: 0 }, cellSize)
    ).toBeCloseTo(1.275686811);
    // cells F14:
    expect(
      getFireSpreadRate(sourceCell, targetCell, { speed: 2, direction: 0 }, cellSize)
    ).toBeCloseTo(2.831591284);
    // cells F32:
    expect(
      getFireSpreadRate(sourceCell, targetCell, { speed: 20, direction: 0 }, cellSize)
    ).toBeCloseTo(64.40222588);
  });
  ...
  it('calculates the fireSpreadRate correctly for forest with suppression fuel type', () => {
    ...
    expect(
      getFireSpreadRate(sourceCell, targetCell, { speed: 1, direction: 0 }, cellSize)
    ).toBeCloseTo(6.268576733);
    // cells F14:
    expect(
      getFireSpreadRate(sourceCell, targetCell, { speed: 2, direction: 0 }, cellSize)
    ).toBeCloseTo(12.42085772);
    // cells F32:
    expect(
      getFireSpreadRate(sourceCell, targetCell, { speed: 20, direction: 0 }, cellSize)
    ).toBeCloseTo(212.927632);
  });
  ...
  it('takes into account wind direction', () => {
    ...
    expect(
      getFireSpreadRate(sourceCell, targetCell, { speed: 2, direction: 90 }, cellSize)
    ).toBeCloseTo(7.0274244);
    expect(
      getFireSpreadRate(sourceCell, targetCell, { speed: 2, direction: -90 }, cellSize)
    ).toBeCloseTo(7.0274244);
    expect(
      getFireSpreadRate(sourceCell, targetCell, { speed: 2, direction: 180 }, cellSize)
    ).toBeCloseTo(3.86127);
  });
});
