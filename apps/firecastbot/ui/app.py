...
from firecastbot.services.chat_service import ChatService
from firecastbot.services.document_service import DocumentService
from firecastbot.services.llm_service import LLMService
from firecastbot.services.speech_service import SpeechService
from firecastbot.session import initialize_session_state
...
def main() -> None:
    ...
    chat_service = ChatService(settings, llm_service, speech_service)
