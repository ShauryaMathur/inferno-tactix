...
def build_embeddings(
    ...
    try:
        ...
        raise RuntimeError(
            "sentence-transformers is not installed. Install apps/requirements.txt before building embeddings."
        ) from exc
...
def main() -> None:
    ...
    parser.add_argument(
        "--input",
        default="apps/chatwithme/incident_response_docs/doctrine_kb.jsonl",
        help="Path to doctrine KB JSONL.",
    )
    parser.add_argument(
        "--keyword-output",
        default="apps/chatwithme/incident_response_docs/doctrine_keyword_index.json",
        help="Path to keyword/BM25 index JSON.",
    )
    parser.add_argument(
        "--embeddings-output",
        default="apps/chatwithme/incident_response_docs/doctrine_embeddings.npy",
        help="Path to dense embedding matrix (.npy).",
    )
    parser.add_argument(
        "--embedding-metadata-output",
        default="apps/chatwithme/incident_response_docs/doctrine_embeddings.meta.jsonl",
    ...
    parser.add_argument(
        ...
        help="SentenceTransformer model to use for dense retrieval.",
    )
    parser.add_argument(
        "--skip-embeddings",
        action="store_true",
