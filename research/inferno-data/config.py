...
# NETCDF/CACHE ────────────────────────────────────────────────────────────
BASE_URL_TMPL = (
    "http://thredds.northwestknowledge.net:8080/thredds/dodsC/MET/{feat}/{feat}_{year}.nc"
)
CACHE_PICKLE_PATH = os.path.expanduser(
    "/projects/academic/courses/cse676s25/sbellary/Inferno_Tactics/wildfire_cache.pkl.zst"
)
SAVE_CACHE = False
